...
# for real once per slug and hard-coding the observed digests — see
# .claude/nightingale-session-numbers.md, "Fetch pins (Task 2)" for the
# exact commands that produced these values.
